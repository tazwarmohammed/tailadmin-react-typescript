      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-white/70 backdrop-blur-sm border border-gray-300 rounded-xl text-gray-600 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200"
          />
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-4 bg-white/70 backdrop-blur-sm border border-gray-300 rounded-xl text-gray-600 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200"
          />
            <button
              type="button"
            ...
            >
              {!showPassword ? (
                <svg className="h-5 w-5 text-gray-300 hover:text-gray-800 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="-mt-1">
          <button
            type="submit"
            className="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white hover:text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:border-transparent flex items-center justify-center gap-2"
          >
            {/* Login Icon */}
        ...
        <div className="-mt-3">
          <button
            type="button"
            className="text-gray-400 hover:text-gray-800 text-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:border-transparent"
          >
