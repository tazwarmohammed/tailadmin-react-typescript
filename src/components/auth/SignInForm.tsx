    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="-mt-1">
          <button
            type="submit"
            className="w-full py-2 bg-blue-400 hover:bg-white text-white hover:text-blue-400 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/100 focus-visible:border-transparent flex items-center justify-center gap-2"
          >
            {/* Login Icon */}
